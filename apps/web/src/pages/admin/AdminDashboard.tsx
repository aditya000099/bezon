          ...
          <Card className="bg-white border-slate-200 shadow-sm">
            ...
            <CardContent className="space-y-4">
              {orders.map((o) => (
                <div
                  key={o.id}
                  className="border border-slate-100 rounded-xl p-4 bg-slate-50/50 flex flex-col gap-2"
                >
                  <div className="flex justify-between items-center text-xs">
                    <span className="font-extrabold text-slate-900">
                      {o.id}
                    </span>
                    <span className="bg-indigo-100 text-indigo-700 font-bold px-2 py-0.5 rounded capitalize">
                      {o.status}
                    </span>
                  </div>
        ...
        <DialogContent className="max-w-md bg-white border border-slate-200 shadow-2xl p-6 rounded-2xl">
          <DialogHeader className="border-b border-slate-100 pb-4">
            ...
            <DialogDescription>
              ...
              <strong className="text-slate-800">{selectedOrder?.id}</strong>.
            </DialogDescription>
          </DialogHeader>
