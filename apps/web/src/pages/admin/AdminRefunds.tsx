        ...
        <Card className="bg-blue-50 border-blue-200">
          <CardHeader className="py-4">
            <CardTitle className="text-sm font-medium text-blue-800 flex items-center gap-2">
              <MoneyIcon className="h-4 w-4" /> Refund Ready
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-zinc-800 border-zinc-700 text-white shadow-lg">
          <CardHeader className="py-4">
            <CardTitle className="text-sm font-medium text-zinc-300 flex items-center gap-2">
              <MoneyIcon className="h-4 w-4" /> Total Refunded
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            <h2 className="text-lg font-bold mb-4 flex items-center gap-2 text-zinc-900">
              <WarningCircleIcon className="text-amber-500 h-6 w-6" /> Confirm
              Refund Processing
            </h2>
