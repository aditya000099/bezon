...
import { FileCsvIcon, FilePdfIcon } from "@phosphor-icons/react";
...
export const AdminOrderExportControls: React.FC<
  AdminOrderExportControlsProps
> = ({ filters }) => {
  ...
  const handleExport = async (type: "pdf" | "csv") => {
    ...
    try {
      ...
      link.setAttribute(
        "download",
        `orders_report_${new Date().toISOString().split("T")[0]}.${type}`,
      );
