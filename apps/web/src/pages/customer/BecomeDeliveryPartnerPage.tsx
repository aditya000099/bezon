...
export const BecomeDeliveryPartnerPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const response = await api.post('/api/v1/applications/delivery/apply', formData);
        ...
        <Card className="border-rose-100 bg-rose-50/10 shadow-sm">
          ...
          <CardContent>
            <p className="text-slate-700 text-sm">
              Your delivery partner account has been suspended by an administrator due to policy violations or review guidelines.
            </p>
      ...
      <div className="max-w-2xl mx-auto py-10 px-4">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Your application to become a delivery partner is currently under review by our administrators.</CardDescription>
          </CardHeader>
          <CardContent>
    ...
    <div className="max-w-3xl mx-auto py-10 px-4">
      <Card>
        <CardHeader>
          ...
          {user?.deliveryPartner?.status === 'rejected' && user?.deliveryPartner?.rejectionReason && (
