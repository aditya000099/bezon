    ...
    <div className="flex flex-col gap-6 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
              ...
              {loadingAddresses ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div
                    ...
                    className={`cursor-pointer border border-dashed rounded-2xl p-4 transition-all flex flex-col items-center justify-center gap-2 min-h-35 ${
                  ...
                  >
                    <div
                      className={`p-2 rounded-full ${selectedAddressId === "manual" ? "bg-indigo-100" : "bg-white shadow-sm"}`}
                    >
        ...
        <div className="flex flex-col gap-4">
          <Card className="bg-white border-slate-200 shadow-sm">
            <CardHeader>
              <CardTitle className="text-lg font-bold text-slate-800 font-sans">
                Payment Summary
              </CardTitle>
            </CardHeader>
          ...
          <DialogHeader className="border-b border-slate-100 pb-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-1.5">
                ...
                <span className="font-extrabold text-slate-900 text-lg uppercase tracking-tight font-sans">
                  Razorpay <span className="text-indigo-600">Sandbox</span>
                </span>
              </div>
