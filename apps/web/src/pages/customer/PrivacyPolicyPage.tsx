        ...
        <CardContent className="p-6 sm:p-8 flex flex-col gap-8 text-zinc-600 text-sm sm:text-base leading-relaxed">
          ...
          <div className="bg-emerald-50/50 rounded-2xl border border-emerald-100 p-5 flex gap-4">
            ...
            <div className="text-zinc-700 text-xs sm:text-sm font-medium">
              ...
              transparent about how we process and store it.
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <ul className="list-disc pl-14 text-zinc-500 text-xs sm:text-sm font-semibold flex flex-col gap-1.5">
              <li>
                <strong>Profile Information</strong>: Name, email address, phone
                number, and avatar image.
              </li>
              <li>
                <strong>Delivery Information</strong>: Addresses you register
                for shipping purposes.
              </li>
              <li>
                <strong>Transaction Data</strong>: Order logs, purchases, and
                total pricing configurations.
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <ul className="list-disc pl-14 text-zinc-500 text-xs sm:text-sm font-semibold flex flex-col gap-1.5">
              ...
              <li>
                Fulfilling orders, calculating shipping coordinates, and
                tracking deliveries.
              </li>
              <li>
                Improving our web application experience and preventing
                fraudulent activity.
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="pl-8 text-zinc-500 text-sm font-semibold">
              Bezon does not sell your information. We only share details with
              trusted partners:
            </p>
            <ul className="list-disc pl-14 text-zinc-500 text-xs sm:text-sm font-semibold flex flex-col gap-1.5">
              <li>
                <strong>Delivery Partners</strong>: Your name, phone, and
                address are shared with delivery staff to ship products.
              </li>
              <li>
                <strong>Sellers</strong>: Store managers receive your product
                options to pack and ship items.
              </li>
              <li>
                <strong>Compliance</strong>: Under legal audit requirements, if
                officially mandated by regulatory laws.
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="pl-8 text-zinc-500 text-sm font-semibold">
              We use secure cookies to keep you signed in between sessions and
              protect your shopping cart parameters. By navigating our website,
              you approve these standard security cookies. You can manage
              cookies inside your browser settings at any time.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="pl-8 text-zinc-500 text-sm font-semibold">
              ...
              request data erasure or profile exports, please reach out to our
              privacy officer at <strong>privacy@bezon.app</strong>.
            </p>
          </div>
        </CardContent>
      </Card>
